...
public class LLLBinaryValue extends IsoValue<IsoBinaryData> {

    public LLLBinaryValue(IsoType t, IsoBinaryData val) {
        super(t, val);
    }
    ...
    public void write(final OutputStream outs, final boolean binary, final boolean forceStringEncoding)
        ...
        String str = StringUtils.leftPad(String.valueOf(bytes.length), 3, '0');
